...
def train_model():
  ...
  w2v_model = Word2Vec(sentences=sentences, window=10, min_count=1, workers=4, sg = 0, cbow_mean = 1, sample = 0.05 )
...
# Generate and pick your random answer cards
    bot_answers = random.choices(possible_answers, k=16)
...
shots_amount = random.randint(4,8)
